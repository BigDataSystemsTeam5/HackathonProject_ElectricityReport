...
def upsert_pinecone(embed_json, year):
    ...
    try:
        ...
        index.upsert(namespace=f"{year}", vectors=data)
        ...
        pinecone_upsert_logger.error(f"Error in markdwown conversion of file: {str(e)}")
        return
